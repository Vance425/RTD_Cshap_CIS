...
var tabs_Default = {
  defaultTabId: null,
  activeClasses: 'text-gray-900 hover:text-gray-800 dark:text-gray-800 dark:hover:text-gray-800 border-teal-600 dark:border-teal-500 bg-teal-400 hover:bg-teal-500 dark:bg-teal-300 dark:hover:bg-teal-600 font-extrabold',
